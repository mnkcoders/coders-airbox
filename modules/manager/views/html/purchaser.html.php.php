...
$compradores = $this->get_data('incoming');

if(count($compradores) ) : ?>
    <ul class="dashboard purchaser">
        <li class="title"><?php echo AirBoxStringModel::__(
                'Nuevos inversores'); ?></li>
        <?php foreach( $compradores as $investor ) : ?>
        <li>
