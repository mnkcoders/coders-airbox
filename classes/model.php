...
abstract class Model{
    ...
    /**
     * @param \CODERS\AirBox\Model $source
     * @return \CODERS\AirBox\Model
     */
     ...
     * @param \CODERS\AirBox\Model $model Model to import data from
     * @return \CODERS\AirBox\Model
     */
    public function import( \CODERS\AirBox\Model $model ){
     ...
     * @param array $data
     * @return \CODERS\AirBox\Model | boolean
     * @throws \Exception
     */
    public static final function create( $request , $data = array() ){
        ...
        try{
            ...
            $class = sprintf('\CODERS\AirBox\%s\%sModel',
                    strtolower( $module ),strtolower( $model ) );
